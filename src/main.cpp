...
unsigned int nTargetSpacing = 1 * 100;
...
const string strMessageMagic = "Accelerate Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Accelerate", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "vrijdag 5 februari 2016 1fffdeb5-9f0e-44b8-abf2-ef59159c4680";
        CTransaction txNew;
        txNew.nTime = 1454697184;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		uint256 nhashMerkleRoot = uint256("0xf3335f0e2d9c6717366f7bb42f78469cda1d2f47c85864c2a9008e83ed9399d1");
